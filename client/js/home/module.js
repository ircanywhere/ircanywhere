Home = (function() {
	...
	var Module = {
		...
		loginFormSubmit: function(items, callback) {
		...
		resetFormSubmit: function(items, callback) {
		...
		signupFormSubmit: function(items, callback) {
		...
		resetPassFormSubmit: function(items, callback) {
